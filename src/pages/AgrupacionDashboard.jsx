            ...
            <div>
              ...
              <div className="card-shadow bg-white p-6 rounded-lg space-y-4 max-w-xl">
                <div>
                  ...
                  <input defaultValue="Federación Nacional de Lucha" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 ring-sportshausen-red outline-none" />
                </div>
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-1">Email</label>
                  <input defaultValue="contacto@fnl.cl" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 ring-sportshausen-red outline-none" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea rows="3" defaultValue="Federación organizadora de eventos deportivos nacionales." className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 ring-sportshausen-red outline-none" />
                </div>
